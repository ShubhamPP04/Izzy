...
echo "📝 Updating app version to 1.1.2..."
plutil -replace CFBundleShortVersionString -string "1.1.2" "$APP_PATH/Contents/Info.plist"
plutil -replace CFBundleVersion -string "12" "$APP_PATH/Contents/Info.plist"
