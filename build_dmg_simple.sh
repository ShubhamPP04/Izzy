...
echo "📝 Updating app version to 1.0.8..."
plutil -replace CFBundleShortVersionString -string "1.0.8" "$APP_PATH/Contents/Info.plist"
plutil -replace CFBundleVersion -string "8" "$APP_PATH/Contents/Info.plist"
