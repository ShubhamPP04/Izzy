...
echo "📝 Updating app version to 1.1.4..."
plutil -replace CFBundleShortVersionString -string "1.1.4" "$APP_PATH/Contents/Info.plist"
plutil -replace CFBundleVersion -string "13" "$APP_PATH/Contents/Info.plist"
