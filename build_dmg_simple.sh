...
echo "📝 Updating app version to 1.1.1..."
plutil -replace CFBundleShortVersionString -string "1.1.1" "$APP_PATH/Contents/Info.plist"
plutil -replace CFBundleVersion -string "11" "$APP_PATH/Contents/Info.plist"
