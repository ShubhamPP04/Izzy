...
echo "📝 Updating app version to 1.1.6..."
plutil -replace CFBundleShortVersionString -string "1.1.6" "$APP_PATH/Contents/Info.plist"
plutil -replace CFBundleVersion -string "15" "$APP_PATH/Contents/Info.plist"
