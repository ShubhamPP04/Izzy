...
echo "📝 Updating app version to 1.1.5..."
plutil -replace CFBundleShortVersionString -string "1.1.5" "$APP_PATH/Contents/Info.plist"
plutil -replace CFBundleVersion -string "14" "$APP_PATH/Contents/Info.plist"
