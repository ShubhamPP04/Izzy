...
echo "📝 Updating app version to 1.0.9..."
plutil -replace CFBundleShortVersionString -string "1.0.9" "$APP_PATH/Contents/Info.plist"
plutil -replace CFBundleVersion -string "9" "$APP_PATH/Contents/Info.plist"
