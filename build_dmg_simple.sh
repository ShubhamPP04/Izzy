...
echo "📝 Updating app version to 1.1.0..."
plutil -replace CFBundleShortVersionString -string "1.1.0" "$APP_PATH/Contents/Info.plist"
plutil -replace CFBundleVersion -string "10" "$APP_PATH/Contents/Info.plist"
